...
- **Realistic data** — 22 purchase orders across 6 suppliers, 5 origin agents, 5 trade lanes, 4 ingestion channels (API / CSV / XML / Portal), with full milestone history, exception records, version history, third-party shipments, and booking rules.
...
- **Ops admin surface** — booking rules, critical path templates per trade lane, supplier and agent account management.
